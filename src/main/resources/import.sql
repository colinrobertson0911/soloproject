...
insert into item (itemId, name, description, price, numberInStock) values (ITEM_SEQ.nextval, 'Eggs', 'Various size', '1.15', 20);
...
insert into users_basket(users_userId, basket_itemId) values (1, 3);
insert into users_basket(users_userId, basket_itemId) values (1, 4);
insert into users_basket(users_userId, basket_itemId) values (1, 5);
